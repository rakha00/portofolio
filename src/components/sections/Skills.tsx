...
function SkillTile({ skill, selected, onClick }: { skill: Skill, selected: boolean, onClick: () => void }) {
    return (
        ...
        ${selected
                    ? "bg-indigo-600/10 border-indigo-500/50 shadow-[0_0_30px_rgba(79,70,229,0.2)] scale-105 z-10"
                    : "bg-zinc-900/50 border-zinc-800 hover:bg-zinc-800 hover:border-zinc-700 hover:scale-105"
                }
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    {/* Code Window */}
                                    <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-zinc-800 shadow-2xl relative ring-1 ring-white/5">
                                        <div className="flex items-center justify-between px-4 py-3 bg-[#252526] border-b border-zinc-800/50">
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                {({ className, style, tokens, getLineProps, getTokenProps }) => (
                                                    <pre
                                                        className="p-6 overflow-x-auto h-[300px] text-sm font-mono leading-relaxed bg-transparent scrollbar-custom"
